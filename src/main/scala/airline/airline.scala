...
class Hop(val flightNumber : String, origin : Airport, destination : Airport, departureDate : Date, duration : Int) {
  /*
...
class Segment(val origin : Airport, val destination : Airport, departureDate : Date, duration : Int, hops : Seq[Hop]) {
  /*
